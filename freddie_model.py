...
if __name__ == '__main__':
    ...
    print model_name + " Score:", model.score(X_test, y_test), "\n"
    ...
    print "    Random Forest:         %f           %f           %f" % get_scores(RandomForestClassifier, X_train, X_test, y_train, y_test)
    ...
    plot_roc(X=X, y=y, plot_dir=plot_dir, trial=trial, clf_class=RandomForestClassifier)
    plot_roc(X=X, y=y, plot_dir=plot_dir, trial=trial, clf_class=LogisticRegression)
    plot_roc(X=X, y=y, plot_dir=plot_dir, trial=trial, clf_class=DecisionTreeClassifier)
    plot_roc(X=X, y=y, plot_dir=plot_dir, trial=trial, clf_class=SVC)
